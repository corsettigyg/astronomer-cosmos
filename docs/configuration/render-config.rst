...
- ``normalize_task_display_name``: Opposite behaviour of `normalize_task_id`. This function allows users to set a custom display_name independently of the model name, while preserving the task ID as default.
